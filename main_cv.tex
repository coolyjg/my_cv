...
\newcommand{\makeauthorsbold}[2]{%
  \DeclareNameFormat{author}{%
    ...
    \ifthenelse{\value{listcount}=1}{%
      \ifthenelse{\boolean{bold}}{\mkbibbold{\namepartfamily\addcomma\addspace \namepartgiveni}}{\namepartfamily\addcomma\addspace \namepartgiveni}%
    }{%
      \ifnumless{\value{listcount}}{\value{liststop}}{%
        \ifthenelse{\boolean{bold}}{\mkbibbold{\addcomma\addspace \namepartfamily\addcomma\addspace \namepartgiveni}}{\addcomma\addspace \namepartfamily\addcomma\addspace \namepartgiveni}%
      }{%
    ...
    % {\namepartfamily\addcomma\addspace \namepartgiven}%
    % % 输出逗号和空格
    % \ifmorenames{\addcomma\addspace}{\addcomma\addspace}%
  }%
}
\makeauthorsbold{Chen}{Kang}
% \newcommand{\makeauthorsbold}[1]{%
%   \DeclareNameFormat{author}{%
%   \setboolean{bold}{false}%
%     \renewcommand{\do}[1]{%
%       \StrBefore{##1}{,}[\authorlastname]%
%       \StrBehind{##1}{, }[\authorgivenname]%
%       \expandafter\ifstrequal\expandafter{\authorlastname}{\namepartfamily}{%
%         \expandafter\ifstrequal\expandafter{\authorgivenname}{\namepartgiveni}{%
...
\begin{document}
    ...
    \begin{tablist}
        \item[2022] \tab{}\fullcite{ma2022survey}
        \item[2020] \tab{}\fullcite{li20203}
        \item[2020] \tab{}\fullcite{chen2020lessons}
        \item[2018] \tab{}\fullcite{wu2018rf}
        \item[2018] \tab{}\fullcite{ai2018clip}
        \item[2018] \tab{}\fullcite{zhang2018wonderland}
        \item[2018] \tab{}\fullcite{liu2018dudetx}
        \item[2017] \tab{}\fullcite{gao2017high}
        \item[2017] \tab{}\fullcite{liu2017dudetm}
        \item[2017] \tab{}\fullcite{chen2017evolution}
        \item[2016] \tab{}\fullcite{zhang2016measuring}
        \item[2015] \tab{}\fullcite{su2015systematic}
        \item[2015] \tab{}\fullcite{guo2015mars}
        \item[2013] \tab{}\fullcite{wu2013modeling}
        \item[2013] \tab{}\fullcite{zhao2013liquid}
        \item[2004] \tab{}\fullcite{feng2004accessor}
    \end{tablist}

    \subsection*{Conference Proceedings}
    \begin{tablist}
        \item[2024] \tab{}\fullcite{ren2024scaling}
        \item[2023] \tab{}\fullcite{ji2023falcon}
        \item[2023] \tab{}\fullcite{zhang2023partial}
        \item[2023] \tab{}\fullcite{shan2023explore}
        \item[2023] \tab{}\fullcite{wang2023noswalker}
        \item[2023] \tab{}\fullcite{chen2023achieving}
        \item[2023] \tab{}\fullcite{huan2023tea}
        \item[2022] \tab{}\fullcite{chen2022seqdlm}
        \item[2022] \tab{}\fullcite{huan2022t}
        \item[2022] \tab{}\fullcite{ren2022libcrpm}
        \item[2022] \tab{}\fullcite{huan2022tegraph}
        \item[2021] \tab{}\fullcite{shan2021geometric}
        \item[2021] \tab{}\fullcite{yang2021random}
        \item[2021] \tab{}\fullcite{ma2021thinking}
        \item[2021] \tab{}\fullcite{ma2021roart}
        \item[2020] \tab{}\fullcite{ma2020asymnvm}
        \item[2020] \tab{}\fullcite{shen2020occlum}
        \item[2019] \tab{}\fullcite{yang2019knightking}
        \item[2019] \tab{}\fullcite{ma2019x}
        \item[2019] \tab{}\fullcite{liu2019building}
        \item[2018] \tab{}\fullcite{shen2018isolate}
        \item[2018] \tab{}\fullcite{li2018regraph}
        \item[2018] \tab{}\fullcite{zhang2018graphp}
        \item[2017] \tab{}\fullcite{ai2017squeezing}
        \item[2017] \tab{}\fullcite{su2017rfp}
        \item[2016] \tab{}\fullcite{zhang2016exploring}
        \item[2015] \tab{}\fullcite{zhang2015wrong}
        \item[2015] \tab{}\fullcite{guo2015bidding}
        \item[2014] \tab{}\fullcite{mu2014paxos}
        \item[2006] \tab{}\fullcite{chen2006distributed}
    \end{tablist}
